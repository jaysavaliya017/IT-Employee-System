...
const EmployeeSalarySlips = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'NOT_GENERATED':
      default:
        return <span className="px-2 py-1 text-xs font-medium rounded-full bg-amber-50 text-amber-700 flex items-center gap-1"><AlertCircle className="w-3 h-3" /> Not Generated</span>;
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">My Salary Slips</h1>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl shadow-sm p-12 border border-slate-100 text-center">
          ...
          <h3 className="text-lg font-semibold text-slate-900 mb-2">No Salary Slips Found</h3>
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {slips.map((slip) => (
              <div key={slip.id} className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-600">Salary Amount</span>
                    <span className="font-medium text-slate-900">{formatCurrency(slip.salaryAmount)}</span>
                  </div>
                  {Number(slip.bonus) > 0 && (
                    <div className="flex justify-between items-center">
