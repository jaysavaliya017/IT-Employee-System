            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-200">
                  ...
                  <th className="text-left py-3 px-4 text-xs font-semibold uppercase tracking-wide text-slate-400">Designation</th>
              ...
              <tbody>
                {dashboardData?.teamMembers?.map((member: any) => (
                  <tr key={member.id} className="border-b border-slate-100 hover:bg-slate-50/70 transition-colors">
                    <td className="py-3 px-4">
                      <p className="font-medium text-slate-800">{member.fullName}</p>
                      <p className="text-xs text-slate-500">{member.employeeCode}</p>
                    </td>
                    <td className="py-3 px-4 text-sm text-slate-600">{member.designation || '-'}</td>
                    <td className="py-3 px-4 text-sm text-slate-600">{member.department?.name || '-'}</td>
                  </tr>
                ))}
              </tbody>
            </table>
