  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Resource Requests</h1>
          <p className="text-sm text-slate-500 mt-1">Request items like books, pens, mouse, keyboard, etc.</p>
        </div>
        <button
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-3">Request Type</label>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none resize-none"
                />
              </div>
                  ...
                  >
                    ...
                    {request.status === 'APPROVED' && request.approvedAt && (
                      <div className="text-right">
                        ...
                        <p className="text-sm font-medium text-slate-700">{request.approver?.fullName || 'Admin'}</p>
                      </div>
                    )}
