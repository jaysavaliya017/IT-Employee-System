      ...
      <Card>
        <CardContent>
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="text-slate-500">{user.designation || user.role}</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-medium text-slate-800">{user.employeeCode}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-medium text-slate-800">{user.department?.name || '-'}</p>
              </div>
            </div>
            ...
            {user.teamLeader && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-800">{user.teamLeader.fullName}</p>
                </div>
              </div>
            )}
