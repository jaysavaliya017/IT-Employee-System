          ...
          <CardContent>
            <div className="space-y-3">
              {pastHolidays.map((holiday) => (
                <div
                  key={holiday.id}
                  className="flex items-center gap-4 p-4 bg-slate-50 rounded-lg opacity-60"
                >
                  <div className="w-14 h-14 bg-slate-200 rounded-xl flex flex-col items-center justify-center">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-slate-600">{holiday.title}</p>
