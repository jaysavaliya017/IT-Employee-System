...
const NotificationDropdown = () => {
  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      ...
      default:
        return <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-600">🔔</div>;
    }
  };
            ...
            {loading ? (
              ...
              notifications.map((notification) => (
                <div
                  ...
                  className={`px-4 py-3 hover:bg-slate-50 cursor-pointer border-b border-slate-50 last:border-0 ${!notification.isRead ? 'bg-primary-50/50' : ''}`}
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between">
                        ...
                        <span className="text-xs text-slate-400 ml-2">{formatTimeAgo(notification.createdAt)}</span>
                      </div>
