...
export const biometricApi = {
  ...
  createDevice: (data: any) => api.post('/biometric/devices', data),
  updateDevice: (id: string, data: any) => api.put(`/biometric/devices/${id}`, data),
  deleteDevice: (id: string) => api.delete(`/biometric/devices/${id}`),

  testDevice: (id: string) => api.post(`/biometric/devices/${id}/test`),
  syncDevice: (id: string) => api.post(`/biometric/devices/${id}/sync`),
  syncAll: () => api.post('/biometric/sync-all'),
  processPunches: () => api.post('/biometric/process'),

  getEnrollments: (id: string) => api.get(`/biometric/devices/${id}/enrollments`),
  mapEmployee: (userId: string, biometricId: string | null) =>
    api.put(`/biometric/employees/${userId}/mapping`, { biometricId }),
  ...
  getPunches: (params?: {
    ...
    from?: string;
    to?: string;
  }) => api.get('/biometric/punches', { params }),
};
