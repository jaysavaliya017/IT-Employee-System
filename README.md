# StaffSync - IT Company Attendance & Leave Management System
...
5. **Update .env with your PostgreSQL credentials**
   ```
   DATABASE_URL="postgresql://postgres:yourpassword@localhost:5432/staffsync?schema=public"
...
| Role | Email | Password |
|------|-------|----------|
| Super Admin | superadmin@staffsync.com | SuperAdmin@123 |
| HR/Admin | admin@staffsync.com | Admin@123 |
| Manager | manager@staffsync.com | Manager@123 |
| Team Leader | teamleader@staffsync.com | Leader@123 |
| Employee | employee@staffsync.com | Employee@123 |
...
### Server (.env)
```
DATABASE_URL=postgresql://postgres:password@localhost:5432/staffsync
